...
import activity.ReservationActivity;
import adapter.CategoryAdapter;
import adapter.ItemAdapter;
import helper.TransitionHelper;
import ir.cafebazaar.booker.booker.R;
import model.Category;
import model.Item;
import widget.OffsetDecoration;
...
public class ItemSelectionFragment extends Fragment {
    ...
    private void setUpQuizGrid(RecyclerView categoriesView) {
        ...
        mAdapter = new ItemAdapter(getActivity(), ((ReservationActivity) getActivity()).category.getName());
...
//        final Bundle transitionBundle = sceneTransitionAnimation.toBundle();
        Intent startIntent = ItemActivity.getStartIntent(activity, item, ((ReservationActivity) activity).name, ((ReservationActivity) activity).photoURI  );
