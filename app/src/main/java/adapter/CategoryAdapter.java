...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    private void updateCategories(Activity activity) {
        mCategories = new ArrayList<Category>(3);
        mCategories .add(new Category("Books", "books", Theme.booker));
        mCategories .add(new Category("Rooms", "rooks", Theme.booker));
        mCategories .add(new Category("IRest", "irest", Theme.booker));
    }
