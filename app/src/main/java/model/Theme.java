 ...
 * In one case in Booker it is more performant to work like this.
 ...
 */
public enum Theme {
    booker(R.color.booker_primary, R.color.booker_primary_dark,
            R.color.theme_blue_background, R.color.theme_blue_text,
            R.color.booker_accent, R.style.Booker),
    blue(R.color.theme_blue_primary, R.color.theme_blue_primary_dark,
            R.color.theme_blue_background, R.color.theme_blue_text,
            R.color.theme_blue_accent, R.style.Booker_Blue),
    green(R.color.theme_green_primary, R.color.theme_green_primary_dark,
            ...
            R.color.theme_green_accent, R.style.Booker_Green),
    ...
    yellow(R.color.theme_yellow_primary, R.color.theme_yellow_primary_dark,
            ...
            R.color.theme_yellow_accent, R.style.Booker_Yellow);
